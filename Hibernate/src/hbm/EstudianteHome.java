...
public class EstudianteHome {
	...
	public Estudiante merge(Estudiante detachedInstance) {
		...
		try {
			Estudiante result = (Estudiante) sessionFactory.getCurrentSession()
	...
	public Estudiante findById(int id) {
		...
		try {
			Estudiante instance = (Estudiante) sessionFactory
					.getCurrentSession().get("hbm.Estudiante", id);
			if (instance == null) {
