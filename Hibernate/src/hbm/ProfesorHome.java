...
public class ProfesorHome {
	...
	private static final Log log = LogFactory.getLog(ProfesorHome.class);
	...
	public Profesor findById(int id) {
		...
		try {
			Profesor instance = (Profesor) sessionFactory.getCurrentSession()
					.get("hbm.Profesor", id);
			if (instance == null) {
